...
var Jerk = new (function Jerk() {
  ...
  this.addWatchers = function(block) {
    ...
    return { connect: connect
           , say:     _say.bind(this)
           , action:  _action.bind(this)
           , part:    _part.bind(this)
           , quit:    _quit.bind(this)
           }
  }
  ...
  // CTCP ACTION (/me ...)
  function _action(to, msg) {
    bot.privmsg(to, '\001ACTION ' + msg + '\001')
  }

  function _part(channel) {
    bot.part(channel)
  }

  function _quit(message) {
    bot.quit(message)
  }
})()
